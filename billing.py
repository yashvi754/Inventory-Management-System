...
class BillClass:
    def __init__(self,root):
        ...
        self.root.title("Inventory Management System | Developed By Rangeesh")
        self.root.config(bg="white")
        #===title===
        img_title = Image.open("Images/cart.jpg") # Corrected Path to "Image" folder
        img_title = img_title.resize((40, 40), Image.Resampling.LANCZOS)
        self.icon_title = ImageTk.PhotoImage(img_title)
        ...
        btn_generate=Button(billMenuFrame,text='Generate/Save Bill',cursor="hand2",font=("goudy old style",12,"bold"),bg="#009688",fg="white")
